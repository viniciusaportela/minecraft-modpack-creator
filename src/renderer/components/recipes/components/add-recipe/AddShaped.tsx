...
import PickerButton from '../../../picker-button/PickerButton';
import ItemPicker from '../../../picker-button/ItemPicker';
import { useProjectStore } from '../../../../store/project.store';

interface IAddShapedProps {
  onAdded: () => void;
}

export default function AddShaped({ onAdded }: IAddShapedProps) {
